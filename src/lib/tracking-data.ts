...
export const statusMeta: Record<OrderStatus, {
    ...
    picked_up: {
        label: "Picked Up",
        labelBn: "সংগ্রহ করা হয়েছে",
        colorClass: "text-status-picked",
        bgClass: "bg-accent/10"
    },
    in_transit: {label: "In Transit", labelBn: "পথে আছে", colorClass: "text-status-transit", bgClass: "bg-purple-50"},
    out_for_delivery: {
        label: "Out for Delivery",
        labelBn: "ডেলিভারিতে বের হয়েছে",
        colorClass: "text-status-out",
    ...
    "JDX-240312-7891": {
        ...
        timeline: [
            ...
            },
            {
                ...
                status: "picked_up",
                title: "Picked Up",
                titleBn: "সংগ্রহ করা হয়েছে",
                description: "Parcel collected from merchant",
                location: "Mirpur-10, Dhaka",
                timestamp: "Mar 12, 2026 – 10:30 AM",
                completed: true,
                active: false
            },
            {
                ...
                title: "In Transit",
                titleBn: "পথে আছে",
                description: "Parcel at sorting hub",
                location: "Uttara Hub, Dhaka",
                timestamp: "Mar 12, 2026 – 11:45 AM",
                completed: true,
                active: false
            },
            {
    ...
    "JDX-240310-4523": {
        ...
        timeline: [
            ...
            },
            {
                ...
                title: "In Transit",
                titleBn: "পথে আছে",
                description: "Parcel in transit via intercity route",
                location: "Aricha Highway",
            ...
            },
            {
                ...
                title: "Out for Delivery",
                titleBn: "ডেলিভারিতে বের হয়েছে",
                description: "Rider heading to destination",
                location: "Jessore Sadar",
                timestamp: "Mar 11, 2026 – 1:00 PM",
                completed: true,
                active: false
            },
            {
                ...
                title: "Delivered",
                titleBn: "ডেলিভারি সম্পন্ন",
                description: "Parcel delivered — signed by customer",
                location: "Jessore Sadar, Jessore",
                timestamp: "Mar 11, 2026 – 3:47 PM",
                completed: true,
                active: false
            },
        ],
